...
public interface WareHouseMapper extends BaseMapper<WarehouseStock> {
    ...
    void warehouseReduceCount(BigInteger goodsId, Integer quantity);
    ...
    WarehouseStockVo warehouseByIdAndwarehouseLocation(BigInteger goodsId, String toWarehouse);
    @Update("update warehouse_stock set stock_quantity = stock_quantity + #{quantity} where id = #{goodsId}")
    void warehouseAddCount(BigInteger goodsId, Integer quantity);
